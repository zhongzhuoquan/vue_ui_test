    ...
    open() {
      ...
      this.timeOut = setTimeout(() => {
        ...
        if (this.allRound == 1) {
          ...
          //可训练训练次数减一
          this.$store.dispatch(
            'setComprehensiveBCount',
            this.$store.getters.getComprehensiveBCount - 1
          )
          localStorage.setItem(
            'comprehensiveB_count',
            localStorage.getItem('comprehensiveB_count') - 1
          )
          if (localStorage.getItem('comprehensiveB_count') < 1) {
            this.isOpen1 = true
            this.$message({
              message: '可用次数剩余:' + 0 + '次',
              center: true
            ...
            this.$message({
              message:
                '可用次数剩余:' +
                localStorage.getItem('comprehensiveB_count') +
                '次',
              center: true
            })
          }
