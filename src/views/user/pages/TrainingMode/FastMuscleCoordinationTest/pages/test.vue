      ...
      this.timeOut = setTimeout(() => {
        ...
        if (this.allRound == 1) {
          ...
          this.$store.dispatch(
            ...
            this.$store.getters.getFastMuscleCoordinationCount - 1
          )
          localStorage.setItem(
            'fast_muscle_coordination_count',
            localStorage.getItem('fast_muscle_coordination_count') - 1
          )
          if (localStorage.getItem('fast_muscle_coordination_count') < 1) {
            this.isOpen1 = true
            this.$message({
              message: '可用次数剩余:' + 0 + '次',
              center: true
            ...
            this.$message({
              message:
                '可用次数剩余:' +
                localStorage.getItem('fast_muscle_coordination_count') +
                '次',
              center: true
            })
          }
