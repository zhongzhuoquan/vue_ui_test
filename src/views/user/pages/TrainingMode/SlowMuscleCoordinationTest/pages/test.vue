      ...
      this.timeOut = setTimeout(() => {
        ...
        if (this.allRound == 1) {
          ...
          this.$store.dispatch(
            ...
            this.$store.getters.getSlowMuscleCoordinationCount - 1
          )
          localStorage.setItem(
            'slow_muscle_coordination_count',
            localStorage.getItem('slow_muscle_coordination_count') - 1
          )
          if (localStorage.getItem('slow_muscle_coordination_count') < 1) {
            this.$message({
              message: '可用次数剩余:' + 0 + '次',
              center: true
            })
            ...
            this.$message({
              message:
                '可用次数剩余:' +
                localStorage.getItem('slow_muscle_coordination_count') +
                '次',
              center: true
            })
          }
